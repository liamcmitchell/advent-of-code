...
Day11.part1("example.txt") |> IO.inspect(label: "part1")
Day11.part1("input.txt") |> IO.inspect(label: "part1")
Day11.part2("example.txt") |> IO.inspect(label: "part2")
Day11.part2("input.txt") |> IO.inspect(label: "part2")
